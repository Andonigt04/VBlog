        ...
        <form method="POST" action="{{ route('posts.update', $post->id) }}">
            ...
            <div class="mb-5">
                ...
                <select id="tags" name="tags"
                    ...
                    <option value="" disabled>Aukeratu kategoria bat...</option>
            ...
            <div class="mb-6">
                ...
                <textarea id="content" name="content" rows="14" required
                    class="w-full px-3 py-2 bg-zinc-700 border border-zinc-600 rounded-md text-zinc-100
                           placeholder-zinc-400 focus:outline-none focus:ring-2 focus:ring-blue-500 font-mono text-sm">{{ old('content', $post->content) }}</textarea>
                @error('content')
                    <p class="text-red-400 text-sm mt-1">{{ $message }}</p>
                @enderror
            </div>
